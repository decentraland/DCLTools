...
class OBJECT_OT_apply_transforms(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if self.scope == 'SELECTED':
            ...
            objects_to_process = [obj for obj in bpy.data.objects if obj.type in {'MESH', 'CURVE', 'SURFACE', 'META', 'FONT', 'ARMATURE'}]
            ...
            objects_to_process = [obj for obj in collection.objects if obj.type in {'MESH', 'CURVE', 'SURFACE', 'META', 'FONT', 'ARMATURE'}]
